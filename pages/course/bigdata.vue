  ...
  <div class="course-bigdata">
    <main class="content">
      ...
      <section class="course-title">
        ...
        <img src="../../assets/img/course/bigdata/bigdata-fm.jpg" alt="课程详情介绍">
      </section>
...
export default {
  ...
  methods: {
    async getTeachers() {
      const response = await this.$axios.get('http://192.168.8.122/manageapi/wwwapi/findTeacherTeamByType?teacherType=bigdata')
