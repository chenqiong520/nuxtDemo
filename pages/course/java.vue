  ...
  <div class="course-java">
    <main class="content">
      ...
      <section class="course-title">
        ...
        <img src="../../assets/img/course/java/java-fm.jpg" alt="课程详情介绍">
      </section>
      ...
      <section class="course-detail">
        <h2>图文介绍</h2>
        <img src="../../assets/img/course/java/java-bg-js1.png" alt="课程详情介绍">
...
export default {
  ...
  methods: {
    async getTeachers() {
      const response = await this.$axios.get('http://192.168.8.122/manageapi/wwwapi/findTeacherTeamByType?teacherType=java')
    ...
    async getCompendium() {
      const response = await this.$axios.get(
        `${window.location.origin}/datas/course/java-compendium.json`
      )
...
/* banner */
.course-java main.content nav.banner {
  position: relative;
  display: flex;
...
/* 学院课程 */
.course-java main.content .course-title {
  .title {
    height: 31px;
    font-size: 32px;
    font-weight: 500;
...
/* 课程简介 */
.course-java main.content .course-summary {
  h2 {
    height: 38px;
    font-size: 40px;
    font-weight: bold;
...
/* 老师介绍 */
.course-java main.content .course-teacher {
  margin-top: 90px;
...
/* 图文介绍 */
.course-java main.content .course-detail {
  margin-top: 98px;
  width: 100%;
...
/* 课程大纲 */
.course-java main.content .course-compendium {
  margin-top: 64px;
